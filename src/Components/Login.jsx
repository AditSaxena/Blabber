  ...
  return (
    <>
      ...
      <div className="bg-[#eff2f5] h-[calc(100vh-220px)] flex justify-center items-center relative">
        <div className="bg-white h-[80%] w-[50%] shadow-2xl flex flex-col gap-4 items-center justify-center absolute -top-[50px] rounded-xl">
          <Fingerprint className="h-20 w-20 text-[#04a784]" strokeWidth={1.5} />
          <div className="text-3xl p-20">Sign In</div>
